...
int main() {
    ...
    TwoDArray<double>* twoDDouble = new TwoDArray<double>(2, 2, 0.01);
    ...
    TwoDArray<std::string>* twoDString = new TwoDArray<std::string>(2, 2, "default");
